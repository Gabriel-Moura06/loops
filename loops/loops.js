const lugaresQueVisitei = ['Natal', 'caraguatatuba', 'ilhabela', 'Praia Grande', 'Santos', 'maresias', 'Quixaba', 'Ubatuba', 'Aparecida do Norte'];
...
console.log(`Eu e o samuel visitamos em comum, ${lugaresComum}`)

const amigosFace = ['Samuel', 'Giullia', 'Letícia', 'Joao'];
